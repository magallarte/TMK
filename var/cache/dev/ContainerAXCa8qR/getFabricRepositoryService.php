...
// Returns the private 'App\Repository\FabricRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FabricRepository.php';

return $this->privates['App\Repository\FabricRepository'] = new \App\Repository\FabricRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
