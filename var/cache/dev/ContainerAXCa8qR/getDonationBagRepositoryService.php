...
// Returns the private 'App\Repository\DonationBagRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DonationBagRepository.php';

return $this->privates['App\Repository\DonationBagRepository'] = new \App\Repository\DonationBagRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
