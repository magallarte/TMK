...
// Returns the private 'App\Repository\ProcessStatusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProcessStatusRepository.php';

return $this->privates['App\Repository\ProcessStatusRepository'] = new \App\Repository\ProcessStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
