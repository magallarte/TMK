...
// Returns the private 'App\Repository\WorkshopRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/WorkshopRepository.php';

return $this->privates['App\Repository\WorkshopRepository'] = new \App\Repository\WorkshopRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
