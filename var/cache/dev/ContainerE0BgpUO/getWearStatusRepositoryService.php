...
// Returns the private 'App\Repository\WearStatusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/WearStatusRepository.php';

return $this->privates['App\Repository\WearStatusRepository'] = new \App\Repository\WearStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
