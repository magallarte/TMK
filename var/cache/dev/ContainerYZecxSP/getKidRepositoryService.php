...
// Returns the private 'App\Repository\KidRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/KidRepository.php';

return $this->privates['App\Repository\KidRepository'] = new \App\Repository\KidRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
