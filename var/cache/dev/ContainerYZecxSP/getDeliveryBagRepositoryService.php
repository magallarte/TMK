...
// Returns the private 'App\Repository\DeliveryBagRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DeliveryBagRepository.php';

return $this->privates['App\Repository\DeliveryBagRepository'] = new \App\Repository\DeliveryBagRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
