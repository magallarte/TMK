...
// Returns the private 'App\Repository\SchoolStopRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SchoolStopRepository.php';

return $this->privates['App\Repository\SchoolStopRepository'] = new \App\Repository\SchoolStopRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
