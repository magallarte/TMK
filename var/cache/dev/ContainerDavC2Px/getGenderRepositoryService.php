...
// Returns the private 'App\Repository\GenderRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GenderRepository.php';

return $this->privates['App\Repository\GenderRepository'] = new \App\Repository\GenderRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
